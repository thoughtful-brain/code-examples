package com.tutorial.spring_mvc_crud_hibernate;
...
@ComponentScan(basePackages = { "com.tutorial.spring_mvc_crud_hibernate" })
public class AppConfig extends WebMvcConfigurerAdapter {
	...
	public LocalSessionFactoryBean sessionFactory() {
		...
		sessionFactoryBuilder.setPackagesToScan(new String[] { "com.tutorial.spring_mvc_crud_hibernate.POJO" });
	...
	/*
	 * Below method is required to add CORS support.
	 */
	@Bean
