package com.tutorial.spring_mvc_crud_hibernate.controller;
...
import com.tutorial.spring_mvc_validation_crud_hibernate.AppConfig;
...
public class EmployeeControllerTest {
	...
	public void deleteEmployee() throws Exception {
		String expectedJson = "{'Result' : 'OK'}";
		this.mockMvc
				.perform(MockMvcRequestBuilders.post("/delete").contentType(this.post_content).param("employeeId", "7"))
				.andExpect(MockMvcResultMatchers.status().isOk()).andExpect(content().json(expectedJson))
				.andDo(MockMvcResultHandlers.print());
	}
