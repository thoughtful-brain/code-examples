...
<head>
	...
	<link href="resources/themes/lightcolor/blue/jtable.css" rel="stylesheet" type="text/css" />
	<link href="resources/jquery-ui.min.css" rel="stylesheet" type="text/css" />
	
	<script type="text/javascript" src="resources/jquery-3.1.1.min.js"></script>
	<script type="text/javascript" src="resources/jquery-ui.min.js"></script>
	<script type="text/javascript" src="resources/jquery.jtable.min.js" ></script>
	<script type="text/javascript" src="resources/jquery.jtable.js"></script>
	<script type="text/javascript" src="resources/employee.js"></script>
	
	<!-- For validations below files needs to be added -->
